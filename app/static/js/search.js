// Get projects from search
const getProjects = (searchKey) => {
    fetch(`/TrixEx/search/projects/${searchKey}`) //change this to encoded. I think the @ in the email address is messing up java
        .then(res => res.json())
        .then(projects => {
